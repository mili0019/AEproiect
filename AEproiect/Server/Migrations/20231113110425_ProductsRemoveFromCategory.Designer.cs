...
namespace AEproiect.Server.Migrations
{
    ...
    [Migration("20231113110425_ProductsRemoveFromCategory")]
            ...
            modelBuilder.Entity("AEproiect.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 11, 13, 13, 4, 25, 340, DateTimeKind.Local).AddTicks(3150),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 11, 13, 13, 4, 25, 340, DateTimeKind.Local).AddTicks(3212),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 11, 13, 13, 4, 25, 340, DateTimeKind.Local).AddTicks(3215),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 11, 13, 13, 4, 25, 340, DateTimeKind.Local).AddTicks(3218),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
