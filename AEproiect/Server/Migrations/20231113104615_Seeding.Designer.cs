...
namespace AEproiect.Server.Migrations
{
    ...
    [Migration("20231113104615_Seeding")]
            ...
            modelBuilder.Entity("AEproiect.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 11, 13, 12, 46, 15, 799, DateTimeKind.Local).AddTicks(8080),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 11, 13, 12, 46, 15, 799, DateTimeKind.Local).AddTicks(8128),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 11, 13, 12, 46, 15, 799, DateTimeKind.Local).AddTicks(8131),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 11, 13, 12, 46, 15, 799, DateTimeKind.Local).AddTicks(8134),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
